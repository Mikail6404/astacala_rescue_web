...
<body class="flex h-screen">
    ...
    <div class="w-1/2 h-full">
        <img src="<?php echo e(asset('image/imagelogin.jpg')); ?>" alt="Login Image" class="object-cover w-full h-full">
    </div>

</body>

</html>
<?php /**PATH D:\astacala_rescue_mobile\astacala_resque-main\astacala_rescue_web\resources\views/login.blade.php ENDPATH**/ ?>
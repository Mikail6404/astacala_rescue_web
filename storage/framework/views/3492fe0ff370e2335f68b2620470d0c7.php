...
<body class="bg-white p-10">
    ...
    <form action="<?php echo e(route('profil.admin.update')); ?>" method="POST" class="max-w-xl mx-auto">
        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\astacala_rescue_mobile\astacala_resque-main\astacala_rescue_web\resources\views/edit_profil_admin.blade.php ENDPATH**/ ?>
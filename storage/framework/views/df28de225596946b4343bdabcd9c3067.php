    ...
    <div class="w-48 bg-white text-black flex flex-col h-screen border-r shadow-md font-semibold" x-data="{ openPublikasi: false }">
        ...
        <nav class="flex-grow">
            <ul class="mt-6 space-y-1">
                ...
                <!-- Logout -->
                <li>
                    <a href="<?php echo e(route('logout')); ?>" class="flex items-center px-4 py-3 hover:bg-gray-100 transition">
    ...
    <div class="flex flex-grow items-center justify-center">
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            ...
            <form id="updateAdminForm" class="space-y-4">
                <?php echo csrf_field(); ?>
                <input type="hidden" id="adminId" value="<?php echo e($id); ?>">

                <div>
                    <label class="block mb-1 text-sm font-medium">Username</label>
                    <input type="text" name="username_akun_admin" id="username_akun_admin" value="<?php echo e($username); ?>"
                ...
                <div>
                    ...
                    <input type="text" name="nama_lengkap_admin" id="nama_lengkap_admin" value="<?php echo e($name); ?>"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir_admin" id="tanggal_lahir_admin" value="<?php echo e($birthDate); ?>"
                        class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-orange-400" />
                </div>

                <div>
                    <label class="block mb-1 text-sm font-medium">Tempat Lahir</label>
                    <input type="text" name="tempat_lahir_admin" id="tempat_lahir_admin" value="<?php echo e($birthPlace); ?>"
                        class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-orange-400" />
                </div>

                <div>
                    <label class="block mb-1 text-sm font-medium">No Handphone</label>
                    <input type="text" name="no_handphone_admin" id="no_handphone_admin" value="<?php echo e($phone); ?>"
                        class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-orange-400" />
                </div>

                <div>
                    <label class="block mb-1 text-sm font-medium">No Anggota</label>
                    <input type="text" name="no_anggota" id="no_anggota" value="<?php echo e($memberNumber); ?>"
                        class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-orange-400" />
                </div>
...
<?php /**PATH D:\astacala_rescue_mobile\astacala_resque-main\astacala_rescue_web\resources\views/ubah_admin.blade.php ENDPATH**/ ?>
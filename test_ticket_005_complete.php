...
if ($hasApiUpdate && $hasPutRoute && $hasAjax && $hasApiDelete) {
    ...
    echo "REQUIRED FIXES:\n";
    if (!$hasApiUpdate) echo "- Add apiUpdateAdmin method to AdminController\n";
    if (!$hasPutRoute) echo "- Add PUT route for admin updates\n";
    if (!$hasAjax) echo "- Convert form to AJAX implementation\n";
}
